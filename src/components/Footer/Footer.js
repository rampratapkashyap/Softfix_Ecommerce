    ...
    <footer className='footer bg-black'>
      <div className = "container py-4 text-center">
        <div className='flex align-center justify-center text-white fw-3 fs-14'>
          ...
          <div className='vert-line'></div>
          <Link to = "/" className='text-uppercase'>About Softfix</Link>
        </div>
        <span className='text-white copyright-text text-manrope fs-14 fw-3'>&copy; 2023 Ram kashyap. All Rights Reserved.</span>
      </div>
    </footer>
  )
}
